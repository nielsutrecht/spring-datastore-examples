...
public class DockerImages {
    ...
    public static final DockerImageName ELASTIC_SEARCH = DockerImageName.parse("docker.elastic.co/elasticsearch/elasticsearch:8.6.2");
    public static final DockerImageName KAFKA = DockerImageName.parse("confluentinc/cp-kafka:7.3.2");
    public static final DockerImageName INFINISPAN = DockerImageName.parse("infinispan/server:14.0");
